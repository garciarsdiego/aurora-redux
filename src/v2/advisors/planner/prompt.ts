...
// Source: pal-mcp-server@7afc7c1 systemprompts/planner_prompt.py
...
MULTI-STEP MODE
When step_number < total_steps, after your JSON object append one newline and exactly one line:
[CONTINUE: <one concise sentence describing the focus for the next planning step>]
Use this continuation line only when another planning step will follow; omit it on the final step.
`;
