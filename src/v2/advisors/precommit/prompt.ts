...
// Source: pal-mcp-server@7afc7c1 systemprompts/precommit_prompt.py
...
[CONTINUE: <one concise sentence describing the focus for the next validation step>]
Omit this line only on the final validation step when output is complete.
`;
