...
// Source: pal-mcp-server@7afc7c1 systemprompts/thinkdeep_prompt.py
// © BeehiveInnovations — see ../NOTICE.md.

export const THINKDEEP_SYSTEM_PROMPT = `
ROLE
...
MULTI-STEP MODE
When step_number < total_steps, you MUST end your response with a single line containing exactly:
[CONTINUE: <one concise sentence describing the focus for the next step>]
Omit this line only when the thinking pass for this invocation is complete (final step).
`;
